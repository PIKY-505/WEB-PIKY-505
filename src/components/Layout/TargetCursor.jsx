...
import "../../styles/TargetCursor.scss";
...
const TargetCursor = ({
  ...
  useEffect(() => {
    ...
    const tickerFn = () => {
      ...
      // --- NUEVO: Recalcular posición si el objetivo se mueve (para las monedas) ---
      if (activeTarget) {
        // Si el objetivo desapareció del DOM (ej. moneda recogida), forzamos la salida
        if (!activeTarget.isConnected) {
          if (currentLeaveHandler) currentLeaveHandler();
          return;
        }

        // Actualizamos las coordenadas del objetivo en tiempo real
